...
<body>
  ...
  <div class="container container-full">
    <div class="filter-search-container" style="position: sticky; top: 100px;">
      <form class="form-search" method="GET" action="{{ route('vacancy.search') }}">
        ...
        <div class="filter-item">
          <button type="submit" class="btn text-white" style="background: #800">Search</button>
        </div>
      </form>
    </div>
  ...
  <script>
    function loadJobDetails(jobId) {
      if (window.innerWidth <= 768) {
        window.location.href = `/loker/jobs/show/${jobId}`;
      } else {
