    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-header d-flex">
                <h3 class="card-title mr-auto">Edit Your CV</h3>
            ...
            <div class="card-body">
                <form action="{{ route('applicant_page.update', $applicant->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <a href="{{ route('applicant_page.profile') }}" class="btn btn-secondary">Cancel</a>
                </form>
            </div>
        </div>
    </div>
...
<script>
    ...
    createApp({
        ...
        methods: {
            ...
            fetchData() {
                fetch('{{route('edit_api_applicant', ['id' => $applicant->id ])}}')
