...
<h1 class="m-0 text-dark">
    ...
    <a href="{{ route('pipelines-resindo.index', ['status' => 'applied', 'education' => $request->get('education'), 'job_id' => $request->get('job_id')]) }}" class="status-box status-applied {{ $request->get('status') == 'applied' ? 'active' : '' }}">
        <p>{{ $statusCounts['applied'] }}</p>
        <small>Applied</small>
    </a>
    <a href="{{ route('pipelines-resindo.index', ['status' => 'interview', 'education' => $request->get('education'), 'job_id' => $request->get('job_id')]) }}" class="status-box status-interview {{ $request->get('status') == 'interview' ? 'active' : '' }}">
        <p>{{ $statusCounts['interview'] }}</p>
        <small>Interview</small>
    </a>
    <a href="{{ route('pipelines-resindo.index', ['status' => 'offer', 'education' => $request->get('education'), 'job_id' => $request->get('job_id')]) }}" class="status-box status-offer {{ $request->get('status') == 'offer' ? 'active' : '' }}">
        <p>{{ $statusCounts['offer'] }}</p>
        <small>Offer</small>
    </a>
    <a href="{{ route('pipelines-resindo.index', ['status' => 'accepted', 'education' => $request->get('education'), 'job_id' => $request->get('job_id')]) }}" class="status-box status-accepted {{ $request->get('status') == 'accepted' ? 'active' : '' }}">
        <p>{{ $statusCounts['accepted'] }}</p>
        <small>Accepted</small>
    </a>
    <a href="{{ route('pipelines-resindo.index', ['status' => 'bankcv', 'education' => $request->get('education'), 'job_id' => $request->get('job_id')]) }}" class="status-box status-bankcv {{ $request->get('status') == 'bankcv' ? 'active' : '' }}">
...
<div class="row">
 ...
 -->
                        ...
                        <!-- Sorting Dropdown -->
                        <form method="GET" action="{{ route('pipelines-resindo.index') }}" class="d-flex align-items-center">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('pipelines-resindo.index') }}" method="GET">
