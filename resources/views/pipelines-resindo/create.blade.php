...
@section('title', 'Tambah Applicant - resindo')

@section('content_header')
<h1 class="m-0 text-dark">Tambah Applicant - resindo</h1>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Form Tambah Applicant - Resindo</h3>
            </div>

            <div class="card-body">
                <form action="{{ route('pipelines-resindo.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
